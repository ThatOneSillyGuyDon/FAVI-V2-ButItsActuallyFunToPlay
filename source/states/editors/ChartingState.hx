...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Split Screen', "Creates an effect that Splits the Screen to show both characters at once!\n\nValue 1 - Event Name\nValue 2 - Time, Ease\n\nAdd Both - Adds both splits\nKill Both - Removes both splits\nAdd Left - Adds only the left split\nAdd Right - Adds only the right split\nKill Left - Removes the left split\nKill Right - Removes the right split.\n\nWARNING: DO NOT USE 'backIn', 'backInOut', 'backOut' WHEN TYPING THE EASE\nOTHERWISE IT WILL BREAK!!!"],
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var loadAutosaveBtn:FlxButton = new FlxButton(reloadSong.x, reloadSong.y + 30, 'Load Autosave', function()
		{
