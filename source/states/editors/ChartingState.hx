...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Discord RPC', "Changes the icon and text displayed\non the Discord Activity in someone's profile!\n\nValue 1: Details Txt, State Txt, Icon Name\nValue 2: does nothing\n\nSet Value 1 to \"default\" on all 3\ninputs to change back your\nRich Presence!"],
