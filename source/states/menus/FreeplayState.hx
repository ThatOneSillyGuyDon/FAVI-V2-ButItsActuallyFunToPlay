...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
			...
			case 1: // Extras Menu
				{		
					...
					//{
						...
						addSong('Scrapped', 3, (GameData.scrappedLock != 'unlocked' && GameData.scrappedLock != 'beaten' ? 'mysteryfp' : 'rs'), FlxColor.fromRGB(0, 0, 0), 'PualTheUnTruest', 'HARD', FlxColor.fromRGB(255, 187, 187), (GameData.scrappedLock == "beaten" || GameData.scrappedLock == "unlocked" ? [30, -10] : [25, 0]), "None");
						...
						addSong('Twisted Grins', 3, (GameData.tgLock != 'unlocked' && GameData.tgLock != 'beaten' ? 'mysteryfp' : 'smile'), FlxColor.fromRGB(54, 38, 38), 'PualTheUnTruest', 'HARD', FlxColor.fromRGB(255, 187, 187), (GameData.tgLock == "beaten" || GameData.tgLock == "unlocked" ? [25, -10] : [25, 0]), "Scroll speed changes.");
		...
		if (freeplayMenuList != 2)
		{
			...
			rug.antialiasing = ClientPrefs.data.antialiasing;
			add(rug);
			...
			gramo.antialiasing = ClientPrefs.data.antialiasing;
			add(gramo);
			...
			add(boxBot);
			boxBot.antialiasing = ClientPrefs.data.antialiasing;
		...
		for (i in 0...songs.length)
		{
			...
			else 
			{
				...
				songText2.x -= 346;
				songText2.y -= 280;
				songText2.antialiasing = ClientPrefs.data.antialiasing;
	...
	override function update(elapsed:Float)
	{
		...
		if(songs[curSelected].songName == "Don't Cross!" && grpSongs.members[6] != null && grpSongs.members[6].exists)
			{
				grpSongs.members[4].shake(11, 10, 0.1);
	...
	public static function getDiffRank():String
		...
		public static function getArtistName():String
		{
			switch (PlayState.SONG.song)
			{
				...
				case "Laugh Track" | "Dont Cross" | "Bless" | "Twisted Grins" | "Scrapped": songArtist = "PualTheUnTruest";
