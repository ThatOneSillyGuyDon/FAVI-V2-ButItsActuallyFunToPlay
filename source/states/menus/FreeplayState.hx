		...
		switch (freeplayMenuList)
		{
			...
			case 1: // Extras Menu
				{		
					...
					addSong('Joygrim', 3, (GameData.sinsLock != 'unlocked' && GameData.sinsLock != 'beaten' ? 'mysteryfp' : 'lot1'), FlxColor.fromRGB(105, 30, 30), 'FR3SHMoure', 'HARD', FlxColor.fromRGB(255, 187, 187), (GameData.sinsLock == "beaten" || GameData.sinsLock == "unlocked" ? [24, -21] : [25, 0]), "Just Enjoy.");
