...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (GameData.episode1FPLock == 'unlocked')
		{
			...
			sigmaClick.antialiasing = ClientPrefs.data.antialiasing;
		...
		datBook.antialiasing = ClientPrefs.data.antialiasing;
		add(datBook);
		...
		discordIcon.y += 350;
		discordIcon.antialiasing = ClientPrefs.data.antialiasing;
		add(discordIcon);*/
