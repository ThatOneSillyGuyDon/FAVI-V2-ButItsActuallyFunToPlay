...
class CharacterMenu extends MusicBeatState 
{
    ...
    override public function create() {
        ...
        book1.antialiasing = ClientPrefs.data.antialiasing;
        add(book1);
