...
class RemakedFreeplayMenu extends MusicBeatState
{
	...
	*/
	...
	var storyMenuSongs:Array<Array<Dynamic>> = [
		...
		['Delusional', 1, 'deluavier', FlxColor.fromRGB(79, 32, 32), 'FR3SHMoure', 'INSANE', FlxColor.fromRGB(255, 110, 110)]
	];

	//i think you get the idea
	var legacySongs:Array<Array<Dynamic>> = [
		['Isolated-Legacy', 3, (GameData.legacyILock != 'unlocked' && GameData.legacyILock != 'beaten' ? 'mysteryfp' : 'avierlegacy'), FlxColor.fromRGB(60, 60, 60), 'Toko & obscurity', 'NORMAL', FlxColor.fromRGB(255, 220, 220)]
	];

	var freeplaySongs:Array<Array<Dynamic>> = [
		['Hunted', 2, (GameData.huntedLock != 'unlocked' && GameData.huntedLock != 'beaten' ? 'mysteryfp' : 'goofy'), FlxColor.fromRGB(94, 28, 35), 'JBlitz', 'NORMAL', FlxColor.fromRGB(255, 220, 220)]
	];
