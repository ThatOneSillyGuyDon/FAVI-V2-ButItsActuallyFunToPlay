...
class SubChim {
    public var shader(default, null):SubChimFilter = new SubChimFilter();
...
class SubChimHUD {
    public var shader(default, null):SubChimHUDFilter = new SubChimHUDFilter();
...
class SubChimHUDFilter extends FlxShader {
    @glFragmentSource("
    #pragma header
    ...
    vec3[8] gb_colors() {
         vec3 gb_colors[8];
         gb_colors[0] = vec3(18., 15., 40.)		/255.;
         gb_colors[1] = vec3(46., 30., 92.)		/255.;
         gb_colors[2] = vec3(107., 66., 153.)	/255.;
         gb_colors[3] = vec3(134., 35., 174.)	/255.;
         gb_colors[4] = vec3(222., 57., 233.)   /255.;
         gb_colors[5] = vec3(247., 146., 228.)      /255.;
         gb_colors[6] = vec3(255., 210., 222.)      /255.;
         gb_colors[7] = vec3(247., 250., 234.)      /255.;
        return gb_colors;
    }
...
class SubChimFilter extends FlxShader {
    @glFragmentSource("
    //SHADERTOY PORT FIX
    #pragma header
