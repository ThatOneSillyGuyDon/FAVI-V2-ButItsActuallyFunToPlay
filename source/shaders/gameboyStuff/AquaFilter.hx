...
class Aqua {
    public var shader(default, null):AquaFilter = new AquaFilter();
...
class AquaHUD {
    public var shader(default, null):AquaHUDFilter = new AquaHUDFilter();
...
class AquaHUDFilter extends FlxShader {
    @glFragmentSource("
    #pragma header
    ...
    vec3[4] gb_colors() {
         vec3 gb_colors[4];
         gb_colors[0] = vec3(10., 10., 26.)		/255.;
         gb_colors[1] = vec3(20., 31., 102.)		/255.;
         gb_colors[2] = vec3(51., 92., 204.)	/255.;
         gb_colors[3] = vec3(133., 177., 242.)	/255.;
        return gb_colors;
    }
...
class AquaFilter extends FlxShader {
    @glFragmentSource("
    //SHADERTOY PORT FIX
    #pragma header
