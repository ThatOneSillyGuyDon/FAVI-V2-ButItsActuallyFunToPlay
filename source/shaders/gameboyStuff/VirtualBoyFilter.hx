...
class VirtualBoy {
    public var shader(default, null):VirtualBoyFilter = new VirtualBoyFilter();
...
class VirtualBoyHUD {
    public var shader(default, null):VirtualBoyHUDFilter = new VirtualBoyHUDFilter();
...
class VirtualBoyHUDFilter extends FlxShader {
    @glFragmentSource("
    #pragma header
    ...
    vec3[4] gb_colors() {
        ...
        gb_colors[1] = vec3(85., 0., 0.)		/255.;
        gb_colors[2] = vec3(170., 0., 0.)	/255.;
        gb_colors[3] = vec3(255., 0., 0.)	/255.;
        return gb_colors;
    }
...
class VirtualBoyFilter extends FlxShader {
    @glFragmentSource("
    //SHADERTOY PORT FIX
    #pragma header
