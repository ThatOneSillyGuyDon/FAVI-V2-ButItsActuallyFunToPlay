...
class RedRose {
    public var shader(default, null):RedRoseFilter = new RedRoseFilter();
...
class RedRoseHUD {
    public var shader(default, null):RedRoseHUDFilter = new RedRoseHUDFilter();
...
class RedRoseHUDFilter extends FlxShader {
    @glFragmentSource("
    #pragma header
    ...
    vec3[4] gb_colors() {
         vec3 gb_colors[4];
         gb_colors[0] = vec3(26., 9., 8.)		/255.;
         gb_colors[1] = vec3(77., 19., 19.)		/255.;
         gb_colors[2] = vec3(179., 36., 45.)	/255.;
         gb_colors[3] = vec3(242., 97., 116.)	/255.;
        return gb_colors;
    }
...
class RedRoseFilter extends FlxShader {
    @glFragmentSource("
    //SHADERTOY PORT FIX
    #pragma header
