...
class Gameboy {
    public var shader(default, null):GameboyFilter = new GameboyFilter();
...
class GameboyHUD {
    public var shader(default, null):GameboyHUDFilter = new GameboyHUDFilter();
...
class GameboyHUDFilter extends FlxShader {
    @glFragmentSource("
    #pragma header
...
class GameboyFilter extends FlxShader {
    @glFragmentSource("
    //SHADERTOY PORT FIX
    #pragma header
