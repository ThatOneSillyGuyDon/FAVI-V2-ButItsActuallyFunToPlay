...
class OldFilter {
    public var shader(default, null):OldFilterShader = new OldFilterShader();
...
class OldFilterShader extends FlxShader {
    @glFragmentSource('
    #pragma header
    ...
    void main()
    {
        ...
        float luminancia = dot(col.rgb, vec3(0.299, 0.587, 0.114));
        gl_FragColor = vec4(vec3(luminancia), 1.0);
    }
    ')
    public function new()
        {
