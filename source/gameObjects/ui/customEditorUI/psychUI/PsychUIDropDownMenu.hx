...
import gameObjects.ui.customEditorUI.psychUI.PsychUIBox.UIStyleData;
...
class PsychUIDropDownMenu extends PsychUIInputText
{
	...
	public function new(x:Float, y:Float, list:Array<String>, callback:Int->String->Void, ?width:Float = 100)
	{
		...
		button = new FlxSprite(behindText.width + 1, 0).loadGraphic(Paths.image('editors/ui/dropdown_button'), true, 20, 20);
