...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Window Movement', "If unchecked, disables certain events that edit the window placement/size\n[DOES NOT AFFECT WINDOW NAME CHANGEING].", 'windowMovement', BOOL, true);
		addOption(option);
