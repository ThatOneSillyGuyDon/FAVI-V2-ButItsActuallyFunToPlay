...
class Paths
{
	...
	*/
	...
	inline public static function directoriesWithFile(path:String, fileToFind:String, mods:Bool = true)
	{
		...
		if(currentLevel != null && currentLevel != path)
		{
			var pth:String = getFolderPath(fileToFind, Paths.currentLevel);
	...
	inline static public function getFolderPath(file:String, folder = "preload")
