package libraries.animateatlas.tilecontainer;

import openfl.display.Tileset;
import haxe.Constraints.Constructible;
import openfl.display.BitmapData;
import libraries.animateatlas.JSONData.AnimationData;
import libraries.animateatlas.JSONData.ElementData;
import libraries.animateatlas.JSONData.LayerFrameData;
import libraries.animateatlas.JSONData.LayerData;
import libraries.animateatlas.JSONData.SymbolTimelineData;
import libraries.animateatlas.JSONData.Matrix3DData;
import libraries.animateatlas.JSONData.AtlasData;
import libraries.animateatlas.JSONData.SymbolData;
import libraries.animateatlas.JSONData.SpriteData;
import libraries.animateatlas.HelperEnums.LoopMode;
import libraries.animateatlas.HelperEnums.SymbolType;
