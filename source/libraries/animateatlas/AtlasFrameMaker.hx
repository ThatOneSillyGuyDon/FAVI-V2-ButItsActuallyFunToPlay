package libraries.animateatlas;
...
import libraries.animateatlas.displayobject.SpriteAnimationLibrary;
import libraries.animateatlas.displayobject.SpriteMovieClip;
