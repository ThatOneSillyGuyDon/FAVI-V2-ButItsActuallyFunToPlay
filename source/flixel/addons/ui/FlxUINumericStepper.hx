...
class FlxUINumericStepper extends FlxUIGroup implements IFlxUIWidget implements IFlxUIClickable implements IHasParams
{
			...
			IsPercent:Bool = false)
	{
		...
		if (TextField == null)
		{
			TextField = new FlxUIInputText(0, 0, 25, '', 10, FlxColor.WHITE, 0xFF333333);
			TextField.setFormat(Paths.font("resultsFont.ttf"), 10, FlxColor.WHITE);
		}
		TextField.x = 0;
		TextField.y = 0;
