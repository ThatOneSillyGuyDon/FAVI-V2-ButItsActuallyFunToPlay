...
class FlxUIButton extends FlxUITypedButton<FlxUIText> implements ILabeled implements IFlxUIButton
{
			...
			?Color:FlxColor = FlxColor.WHITE)
	{
		...
		if (Label != null)
		{
			...
			label.setFormat(Paths.font("resultsFont.ttf"), 12, 0xFFFFFFFF, FlxTextAlign.CENTER);
		}
	 ...
	 */
	public function setLabelFormat(?Font:String, Size:Int = 8, Color:FlxColor = 0xFF333333, ?Alignment:FlxTextAlign, ?BorderStyle:FlxTextBorderStyle,
			BorderColor:FlxColor = FlxColor.TRANSPARENT, Embedded:Bool = true):FlxText
	{
		if (label != null)
		{
			label.setFormat(Paths.font("resultsFont.ttf"), 12, 0xFFFFFFFF, FlxTextAlign.CENTER, BorderStyle, BorderColor, Embedded);
			#if flash
	...
	public override function copyStyle(other:FlxUITypedButton<FlxSprite>):Void
	{
		...
		if ((other is FlxUIButton))
		{
			...
			else
			{
				...
				label.setFormat(Paths.font("resultsFont.ttf"), 12, 0xFFFFFFFF, FlxTextAlign.CENTER, t.borderStyle, t.borderColor, t.embedded);
			}
		}
	}
