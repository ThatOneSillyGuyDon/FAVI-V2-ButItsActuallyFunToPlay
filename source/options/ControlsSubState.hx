...
class ControlsSubState extends MusicBeatSubstate {
	...
	private function addBindTexts(optionText:FlxTextAlphabet, num:Int) {
		...
		var text1 = new objects.AttachedFlxText(InputFormatter.getKeyName(keys[0]), 400, 0);
		...
		var text2 = new objects.AttachedFlxText(InputFormatter.getKeyName(keys[1]), 650, 0);
